...
describe('DSL Parser - Edge Cases', () => {
    it('should handle an empty DSL string', () => {
        expect(() => (0, parser_1.parseDSL)('')).toThrow('DSL file is empty or contains only comments. At least one entity block is required.');
    });
    it('should handle a DSL with only comments and whitespace', () => {
      ...
      // Another comment
    `;
        expect(() => (0, parser_1.parseDSL)(dsl)).toThrow('DSL file is empty or contains only comments. At least one entity block is required.');
    });
    ...
    `;
        expect(() => (0, parser_1.parseDSL)(dsl)).toThrow();
    });
...
//# sourceMappingURL=parser-edge-cases.test.js.map