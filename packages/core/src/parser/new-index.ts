...
import { IApp } from '../ir';
import { tokenize } from './new/lexer';
import { parse } from './new/parser';
import { validate } from './new/validator';
import { buildIR } from './new/ir-builder';
  ...
  try {
    ...
    if (diagnostics.length > 0) {
      ...
      throw new DSLParsingError(
        ...
        firstDiagnostic.location.line,
        firstDiagnostic.location.column,
